...
module Implementations
  module Schemas
    # @see ::Implementations::ContributionPathways
    module ContributionPathways
      ...
      # A type matching the known, settable properties of a {Implementations::ContributionPathways}.
