...
module Implementations
  module Schemas
    # @see ::Implementations::GovernanceStructure
    module GovernanceStructure
      ...
      # A type matching the known, settable properties of a {Implementations::GovernanceStructure}.
