...
class CreateSolutionDrafts < ActiveRecord::Migration[7.1]
  def change
    create_table :solution_drafts, id: :uuid do |t|
      t.references :solution, null: true, foreign_key: { on_delete: :nullify }, type: :uuid
      ...
      t.citext :draft_overrides, array: true, default: []
