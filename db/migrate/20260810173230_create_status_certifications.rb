...
class CreateStatusCertifications < ActiveRecord::Migration[7.1]
  TABLES = %i[
    solutions
    solution_drafts
    solution_intakes
  ...
  def change
    add_controlled_vocabulary :status_certifications
  end
  ...
  def create_controlled_vocabulary_table(table_name)
    create_table table_name, id: :uuid do |t|
      ...
      t.bigint :solution_intakes_count, null: false, default: 0
